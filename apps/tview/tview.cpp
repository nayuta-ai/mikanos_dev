...
void CopyUTF8String(char* dst, size_t dst_size, const char* src,
                    size_t src_size, int w, int tab) {
  int x = 0;
...
void DrawLines(const LinesType& lines, int start_line, uint64_t layer_id, int w,
               int h, int tab) {
  char buf[1024];
